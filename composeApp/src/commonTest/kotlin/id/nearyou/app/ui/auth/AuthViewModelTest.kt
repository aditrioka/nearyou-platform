...
class AuthViewModelTest {
    ...
    @Test
    fun `initial state should check authentication status when authenticated`() =
        runTest {
    ...
    @Test
    fun `initial state should show not authenticated when no token`() =
        runTest {
    ...
    @Test
    fun `checkAuthStatus should update state correctly`() =
        runTest {
            // Save token
            mockTokenStorage.saveAccessToken("test_token")
    ...
    @Test
    fun `register with email should call repository correctly`() =
        runTest {
    ...
    @Test
    fun `login should call repository correctly`() =
        runTest {
            val engine =
                MockEngine { request ->
                    respond(
    ...
    @Test
    fun `verifyOtp should update state to authenticated on success`() =
        runTest {
    ...
    @Test
    fun `logout should update state to not authenticated`() =
        runTest {
