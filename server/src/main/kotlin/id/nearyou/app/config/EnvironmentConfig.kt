...
object EnvironmentConfig {
    ...
    private fun getEnv(
        key: String,
        default: String? = null,
    ): String? = dotenv?.get(key) ?: System.getenv(key) ?: default
    ...
    fun printSummary() {
        println(
            ...
            |Redis: ${redisUrl.substringBefore(
                "@",
            ).substringAfter("//").let { if (it.contains(":")) "redis://***:***@${redisUrl.substringAfter("@")}" else redisUrl }}
