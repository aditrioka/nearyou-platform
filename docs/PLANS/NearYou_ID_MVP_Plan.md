...
See [ARCHITECTURE.md](../CORE/ARCHITECTURE.md) for system architecture, module boundaries, data flow, and database schema.

See [INFRA.md](../CORE/INFRA.md) for infrastructure setup, database configuration, and deployment.

See [TESTING.md](../CORE/TESTING.md) for testing strategy, coverage goals, and validation procedures.
