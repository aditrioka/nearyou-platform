...
class AuthRepositoryTest {
    ...
    @Test
    fun `register should return success when API returns 200`() =
        runTest {
            val mockEngine =
                MockEngine { request ->
    ...
    @Test
    fun `register should return failure when API returns error`() =
        runTest {
            val mockEngine =
                MockEngine { request ->
                    respond(
    ...
    @Test
    fun `login with email should return success`() =
        runTest {
            val mockEngine =
                MockEngine { request ->
    ...
    @Test
    fun `login with phone should return success`() =
        runTest {
            val mockEngine =
                MockEngine { request ->
                    respond(
    ...
    @Test
    fun `login should return failure when user not found`() =
        runTest {
            val mockEngine =
                MockEngine { request ->
                    respond(
    ...
    @Test
    fun `verifyOtp should save tokens and return success`() =
        runTest {
            val mockEngine =
                MockEngine { request ->
    ...
    @Test
    fun `verifyOtp should return failure when OTP is invalid`() =
        runTest {
            val mockEngine =
                MockEngine { request ->
                    respond(
    ...
    @Test
    fun `refreshToken should save new tokens and return success`() =
        runTest {
    ...
    @Test
    fun `refreshToken should return failure when no refresh token available`() =
        runTest {
            val mockEngine =
                MockEngine { request ->
    ...
    @Test
    fun `logout should clear all tokens`() =
        runTest {
            // Setup: Save tokens
    ...
    @Test
    fun `isAuthenticated should return true when access token exists`() =
        runTest {
            mockTokenStorage.saveAccessToken("access_token")
    ...
    @Test
    fun `isAuthenticated should return false when no access token`() =
        runTest {
            val mockEngine =
                MockEngine { request ->
                    fail("Should not make HTTP request")
    ...
    @Test
    fun `getAccessToken should return token when available`() =
        runTest {
    ...
    @Test
    fun `getAccessToken should return null when not available`() =
        runTest {
            val mockEngine =
                MockEngine { request ->
                    fail("Should not make HTTP request")
